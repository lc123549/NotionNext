      ...
      <div
        ...
        <div
          ...
          <div className='flex justify-center md:justify-start items-center gap-4'>
            {post.category && (
              <SmartLink href={`/category/${post.category}`} className='mr-4'>
          ...
          <section className='flex-wrap dark:text-gray-200 text-opacity-70 flex text-sm justify-center md:justify-start mt-4 text-white font-light leading-8'>
