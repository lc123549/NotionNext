...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '62de5176e90f8354945181d60c2852fd',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'DMA梦', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '把白天没说完的话，写进夜里的梦。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://dmameng.mcoi.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'DMA梦, 博客, 笔记', // 网站关键词 英文逗号隔开
